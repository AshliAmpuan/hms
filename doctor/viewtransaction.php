      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">View Transaction Management</h2>
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?php if(isset($_GET['accepted'])) { ?>
                            <td><a href="" href="#" data-backdrop="static" data-toggle="modal" data-target="#uploadFile<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-upload"> Upload</i></a></td>
                            <?php } ?>
                          </tr>
                          <?php
                        
                             include('modals/uploadfiles.php');   
