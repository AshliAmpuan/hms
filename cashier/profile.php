      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            $sql = "SELECT * FROM cashier WHERE id = '$cashier_id'";
            ...
            <div class="row mt-sm-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-5 col-12">
                            <label>Phone</label>
                            <input type="tel" name="contact_number" class="form-control" value="<?php echo $row['contact_number'] ?>">
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-12">
                            <label>Bio</label>
                            <textarea rows="6" name="bio" class="form-control summernote-simple"><?php echo $row['bio']; ?></textarea>
                          </div>
                        </div>
                        <!-- <div class="row">
              ...
              if(isset($_POST['editProfile']))
              {
                    ...
                    $sql = "UPDATE cashier SET fullname = '$fullname', email = '$email', contact_number = '$contact_number', bio = '$bio' WHERE id = '$cashier_id'";
